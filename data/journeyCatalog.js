...
export const CATEGORY_POINT_BONUSES = {
  ...
  "Faith & Pilgrimages": 100,
  "American History": 120,
  "Bridges & Engineering": 100,
  "Nature & Adventure": 150,
  "African Heritage": 150,
  "Cities & Cultural Heritage": 100,
  "Awareness Journeys": 200,
  "Historic Cultures": 120,
  "Global Journey": 500,
};
...
export const JOURNEY_CATEGORIES = {
  ...
  FAITH_PILGRIMAGES: "Faith & Pilgrimages",
  AMERICAN_HISTORY: "American History",
  BRIDGES_ENGINEERING: "Bridges & Engineering",
  NATURE_ADVENTURE: "Nature & Adventure",
  AFRICAN_HERITAGE: "African Heritage",
  CITIES_CULTURAL_HERITAGE: "Cities & Cultural Heritage",
  AWARENESS_JOURNEYS: "Awareness Journeys",
  HISTORIC_CULTURES: "Historic Cultures",
  GLOBAL_JOURNEY: "Global Journey",
};
...
const ROUTE_IMAGE_BY_ID = {
  ...
  "acropolis-athens":
    routeImages.acropolis,

  "angkor-wat":
    routeImages.angkorWat,

  "chichen-itza":
    routeImages.chichenItza,

  "forbidden-city":
    routeImages.forbiddenCity,

  "great-buddha":
    routeImages.greatBuddha,

  "great-wall-of-china":
    routeImages.greatWall,

  "great-zimbabwe":
    routeImages.greatZimbabwe,

  "machu-picchu":
    routeImages.machuPicchu,

  "nile-civilization":
    routeImages.nileCivilization,

  petra:
    routeImages.petra,

  "roman-empire":
    routeImages.romanEmpire,

  "terracotta-army":
    routeImages.terracottaArmy,


  // Faith & Pilgrimages

  "bodh-gaya":
    routeImages.bodhGaya,

  "camino-de-santiago":
    routeImages.caminoDeSantiago,

  "canterbury-pilgrimage":
    routeImages.canterburyPilgrimage,

  "kumano-kodo":
    routeImages.kumanoKodo,

  "lourdes-pilgrimage":
    routeImages.lourdesPilgrimage,

  "mecca-pilgrimage-routes":
    routeImages.meccaPilgrimage,

  "mount-sinai":
    routeImages.mountSinai,

  "st-patricks-way":
    routeImages.saintPatricksWay,

  "via-dolorosa":
    routeImages.viaDolorosa,


  // American History

  "alamo-walk":
    routeImages.alamoWalk,

  "boston-freedom-trail":
    routeImages.bostonFreedomTrail,

  "coast-to-coast-usa":
    routeImages.coastToCoast,

  "ellis-island":
    routeImages.ellisIsland,

  "gettysburg-battlefield":
    routeImages.gettysburgBattlefield,
  ...
  "liberty-trail":
    routeImages.libertyTrail,

  "oregon-trail":
    routeImages.oregonTrail,

  "pacific-coast-highway":
    routeImages.pacificCoastHighway,

  "route-66":
    routeImages.route66,

  "selma-to-montgomery":
    routeImages.selmaToMontgomery,


  // Bridges

  "akashi-kaikyo-bridge":
    routeImages.akashiKaikyoBridge,

  "brooklyn-bridge":
    routeImages.brooklynBridge,

  "chapel-bridge":
    routeImages.chapelBridge,

  "danyang-kunshan-grand-bridge":
    routeImages.danyangKunshanBridge,

  "golden-gate-bridge":
    routeImages.goldenGateBridge,

  "magdeburg-water-bridge":
    routeImages.magdeburgWaterBridge,

  "millau-viaduct":
    routeImages.millauViaduct,

  "tower-bridge":
    routeImages.towerBridge,


  // Nature

  "amazon-rainforest":
    routeImages.amazonRainforest,

  "banff-national-park":
    routeImages.banffNationalPark,

  himalayas:
    routeImages.himalayas,

  "irish-cliffs":
    routeImages.irishCliffs,

  "kilimanjaro-base-walk":
    routeImages.kilimanjaroBaseWalk,

  "mount-fuji":
    routeImages.mountFuji,

  "niagara-falls":
    routeImages.niagaraFalls,

  "norwegian-fjords":
    routeImages.norwegianFjords,

  patagonia:
    routeImages.patagonia,

  "scottish-highlands":
    routeImages.scottishHighlands,

  "serengeti-trail":
    routeImages.serengetiTrail,

  "swiss-alps":
    routeImages.swissAlps,

  "victoria-falls":
    routeImages.victoriaFalls,


  // Cities

  "berlin-wall":
    routeImages.berlinWall,

  "eiffel-tower":
    routeImages.eiffelTower,

  "kyoto-temples":
    routeImages.kyotoTemples,

  "seoul-heritage":
    routeImages.seoulHeritage,

  "singapore-gardens":
    routeImages.singaporeGardens,

  "taj-mahal":
    routeImages.tajMahal,

  "tokyo-nights":
    routeImages.tokyoNights,

  "venice-canals":
    routeImages.veniceCanals,
  ...
  "silk-road":
    routeImages.silkRoad,

  "timbuktu-heritage":
    routeImages.timbuktuHeritage,
  ...
  "around-the-world":
    routeImages.aroundTheWorld,

  "autism-awareness":
    routeImages.autismAwareness,

  "breast-cancer-awareness":
    routeImages.breastCancerAwareness,

  "cancer-awareness":
    routeImages.cancerAwareness,
};
...
function createJourney(config) {
  ...
  return {
    ...
    eliteWCoins:
      config.eliteWCoins ??
      calculateEliteWCoins(
        miles
      ),

    passportStamp:
      config.passportStamp ??
      true,
...
const rawJourneys = [
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/acropolis.png"),
    miles: 8,
    difficulty:
      DIFFICULTY.EASY,
  }),
  ...
  createJourney({
    ...
    location:
      "Siem Reap, Cambodia",
    image:
      require("../assets/journeys/angkor.png"),
    miles: 12,
    difficulty:
      DIFFICULTY.MODERATE,
  }),
  ...
  createJourney({
    ...
    location:
      "Yucatán, Mexico",
    image:
      require("../assets/journeys/chichen.png"),
    miles: 10,
    difficulty:
      DIFFICULTY.MODERATE,
  }),
  ...
  createJourney({
    ...
    location:
      "Beijing, China",
    image:
      require("../assets/journeys/forbiddencity.png"),
    miles: 9,
    difficulty:
      DIFFICULTY.MODERATE,
  }),
  ...
  createJourney({
    ...
    location:
      "Northern China",
    image:
      require("../assets/journeys/greatwall.png"),
    miles:
      100,
    difficulty:
  ...
  createJourney({
    ...
    location:
      "Masvingo, Zimbabwe",
    image:
      require("../assets/journeys/zimbabwe.png"),
    miles:
      14,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "Cusco Region, Peru",
    image:
      require("../assets/journeys/machupicchu.png"),
    miles:
      26,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    location:
      "Nile Valley, Egypt",
    image:
      require("../assets/journeys/nile.png"),
    miles:
      30,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    location:
      "Petra, Jordan",
    image:
      require("../assets/journeys/petra.png"),
    miles:
      11,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "Rome, Italy",
    image:
      require("../assets/journeys/romanempire.png"),
    miles:
      20,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    location:
      "Xi’an, China",
    image:
      require("../assets/journeys/terracottaarmy.png"),
    miles:
      10,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "Bodh Gaya, India",
    image:
      require("../assets/journeys/bodh.png"),
    miles:
      8,
    difficulty:
      DIFFICULTY.EASY,
  ...
  createJourney({
    ...
    location:
      "Northern Spain",
    image:
      require("../assets/journeys/camino.png"),
    miles:
      100,
    difficulty:
      DIFFICULTY.LEGENDARY,
  ...
  createJourney({
    ...
    location:
      "Canterbury, England",
    image:
      require("../assets/journeys/canterbury.png"),
    miles:
      30,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    location:
      "Kamakura, Japan",
    image:
      require("../assets/journeys/greatbuddha.png"),
    miles:
      10,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "Kii Peninsula, Japan",
    image:
      require("../assets/journeys/kumano.png"),
    miles:
      45,
    difficulty:
      DIFFICULTY.EXPERT,
  ...
  createJourney({
    ...
    location:
      "Lourdes, France",
    image:
      require("../assets/journeys/lourdes.png"),
    miles:
      12,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "Mecca, Saudi Arabia",
    image:
      require("../assets/journeys/mecca.png"),
    miles:
      25,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/mountsinai.png"),
    miles:
      14,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/stpatricks.png"),
    miles:
      40,
    difficulty:
      DIFFICULTY.EXPERT,
  ...
  createJourney({
    ...
    location:
      "Vatican City",
    image:
      require("../assets/journeys/vatican.png"),
    miles:
      8,
    difficulty:
      DIFFICULTY.EASY,
  ...
  createJourney({
    ...
    location:
      "Jerusalem",
    image:
      require("../assets/journeys/viadolorosa.png"),
    miles:
      6,
    difficulty:
      DIFFICULTY.EASY,
  ...
  createJourney({
    ...
    location:
      "San Antonio, Texas",
    image:
      require("../assets/journeys/alamowalk.png"),
    miles:
      8,
    difficulty:
      DIFFICULTY.EASY,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/bostonfreedom.png"),
    miles:
      10,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "United States",
    image:
      require("../assets/journeys/coasttocoast.png"),
    miles:
      100,
    difficulty:
      DIFFICULTY.LEGENDARY,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/ellisisland.png"),
    miles:
      8,
    difficulty:
      DIFFICULTY.EASY,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/gettysburg.png"),
    miles:
      15,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "United States",
    image:
      require("../assets/journeys/lewisclark.png"),
    miles:
      75,
    difficulty:
      DIFFICULTY.EXPERT,
  ...
  createJourney({
    ...
    location:
      "United States",
    image:
      require("../assets/journeys/liberty.png"),
    miles:
      20,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    location:
      "United States",
    image:
      require("../assets/journeys/oregontrail.png"),
    miles:
      100,
    difficulty:
      DIFFICULTY.LEGENDARY,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/pacificcoast.png"),
    miles:
      75,
    difficulty:
      DIFFICULTY.EXPERT,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/route66.png"),
    miles:
      100,
    difficulty:
      DIFFICULTY.LEGENDARY,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/selma.png"),
    miles:
      25,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    country:
      "Japan",
    location:
      "Kobe to Awaji Island, Japan",
    image:
      require("../assets/journeys/akashi.png"),
    miles:
      8,
    difficulty:
      DIFFICULTY.EASY,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/brooklynbridge.png"),
    miles:
      6,
    difficulty:
      DIFFICULTY.EASY,
  ...
  createJourney({
    ...
    location:
      "Lucerne, Switzerland",
    image:
      require("../assets/journeys/chapelbridge.png"),
    miles:
      6,
    difficulty:
      DIFFICULTY.EASY,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/danyang.png"),
    miles:
      50,
    difficulty:
      DIFFICULTY.EXPERT,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/goldengate.png"),
    miles:
      8,
    difficulty:
      DIFFICULTY.EASY,
  ...
  createJourney({
    ...
    location:
      "Magdeburg, Germany",
    image:
      require("../assets/journeys/magdeburg.png"),
    miles:
      10,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "Millau, France",
    image:
      require("../assets/journeys/millau.png"),
    miles:
      12,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "London, England",
    image:
      require("../assets/journeys/towerbridge.png"),
    miles:
      8,
    difficulty:
      DIFFICULTY.EASY,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/amazon.png"),
    miles:
      50,
    difficulty:
      DIFFICULTY.EXPERT,
  ...
  createJourney({
    ...
    location:
      "Alberta, Canada",
    image:
      require("../assets/journeys/banff.png"),
    miles:
      25,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    location:
      "Himalayan Region",
    image:
      require("../assets/journeys/himalayas.png"),
    miles:
      100,
    difficulty:
      DIFFICULTY.LEGENDARY,
  ...
  createJourney({
    ...
    location:
      "Western Ireland",
    image:
      require("../assets/journeys/irishcliffs.png"),
    miles:
      12,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/kilimanjaro.png"),
    miles:
      30,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    location:
      "Honshu, Japan",
    image:
      require("../assets/journeys/mountfuji.png"),
    miles:
      20,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    image:
      require("../assets/journeys/niagarafalls.png"),
    miles:
      10,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "Western Norway",
    image:
      require("../assets/journeys/norwegianfjords.png"),
    miles:
      40,
    difficulty:
      DIFFICULTY.EXPERT,
  ...
  createJourney({
    ...
    location:
      "Patagonia",
    image:
      require("../assets/journeys/patagonia.png"),
    miles:
      75,
    difficulty:
      DIFFICULTY.EXPERT,
  ...
  createJourney({
    ...
    location:
      "Scotland",
    image:
      require("../assets/journeys/scottishhighlands.png"),
    miles:
      30,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    location:
      "Serengeti, Tanzania",
    image:
      require("../assets/journeys/serengeti.png"),
    miles:
      45,
    difficulty:
      DIFFICULTY.EXPERT,
  ...
  createJourney({
    ...
    location:
      "Swiss Alps",
    image:
      require("../assets/journeys/swissalps.png"),
    miles:
      35,
    difficulty:
      DIFFICULTY.EXPERT,
  ...
  createJourney({
    ...
    location:
      "Victoria Falls",
    image:
      require("../assets/journeys/victoriafalls.png"),
    miles:
      12,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "Cape Coast, Ghana",
    image:
      require("../assets/journeys/ghanacape.png"),
    miles:
      10,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "South Africa",
    image:
      require("../assets/journeys/nelsonmandela.png"),
    miles:
      20,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    location:
      "Timbuktu, Mali",
    image:
      require("../assets/journeys/timbuktu.png"),
    miles:
      30,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    location:
      "Kyoto, Japan",
    image:
      require("../assets/journeys/kyototemples.png"),
    miles:
      12,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "Singapore",
    image:
      require("../assets/journeys/singapore.png"),
    miles:
      12,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "Tokyo, Japan",
    image:
      require("../assets/journeys/tokyonights.png"),
    miles:
      20,
    difficulty:
      DIFFICULTY.ADVANCED,
  ...
  createJourney({
    ...
    location:
      "Venice, Italy",
    image:
      require("../assets/journeys/venice.png"),
    miles:
      10,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "Worldwide",
    image:
      require("../assets/journeys/autism.png"),
    miles:
      12,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "Worldwide",
    image:
      require("../assets/journeys/breastcancer.png"),
    miles:
      15,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    location:
      "Tulsa, Oklahoma",
    image:
      require("../assets/journeys/blackwallstreet.png"),
    miles:
      10,
    difficulty:
      DIFFICULTY.MODERATE,
  ...
  createJourney({
    ...
    title:
      "Nelson Mandela Freedom Journey",
    subtitle:
  ...
  createJourney({
    ...
    location:
      "Asia and Europe",
    image:
      require("../assets/journeys/silkroad.png"),
    miles:
      100,
    difficulty:
      DIFFICULTY.LEGENDARY,
...
export function getJourneysByDifficulty(
  difficulty
) {
  return JOURNEY_CATALOG.filter(
    (journey) =>
